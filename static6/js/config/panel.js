    ...
    getTree: function () {
        if (!this.tree) {
            var store = Ext.create('Ext.data.TreeStore', {
                ...
                proxy: {
                    type: 'ajax',
                    url: '/plugin/AlternateObjectTrees/admin/get-alternate-object-trees',
                    reader: {
                        type: 'json'
                    }
                }
...
//                     dataUrl: '/plugin/AlternateObjectTrees/admin/get-alternate-object-trees',
//                     requestMethod: "GET",
// //                    baseParams: {
// //                        active: 0
// //                    },
...
//                 }),
    ...
    openTreeConfig: function (id) {
        ...
        Ext.Ajax.request({
            url: "/plugin/AlternateObjectTrees/admin/get-alternate-object-tree",
            params: {
                name: id
            },
...
//                data.text = data.name;
    ...
    addFieldComplete: function (button, value, object) {
        ...
        if (button == "ok" && value.length > 2 && regresult == value) {
            ...
            Ext.Ajax.request({
                url: "/plugin/AlternateObjectTrees/admin/add-alternate-object-tree",
                params: {
                    name: value
                },
                success: function (response) {
    ...
    deleteField: function (view, model) {
        Ext.Ajax.request({
            url: "/plugin/AlternateObjectTrees/admin/del-alternate-object-tree",
            params: {
                id: model.get('id')
            }
        });
